...
import { MdExpandMore, MdTouchApp, MdTune } from "react-icons/md";
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-2 pt-4 border-t border-slate-100">
              ...
              <div className="relative">
                ...
                <span className="absolute right-3 top-2.5 text-slate-400 pointer-events-none text-xl">
                  <MdExpandMore />
                </span>
              </div>
              <p className="text-[11px] text-[#5e7b8d] italic mt-1">
                * Hệ thống sẽ tự động chọn câu hỏi ngẫu nhiên từ ngân hàng đã
                chọn.
              </p>
            </div>
