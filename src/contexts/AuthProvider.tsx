...
import { forgotPasswordApi, loginApi, registerApi, changePasswordApi, verifyEmailApi, verifyOtpApi, refreshTokenApi, googleLoginApi, getCurrentUserApi, decodeJWT, logoutApi } from "../services/authService";
...
const AuthProvider = ({ children }: AuthProviderProps) => {
    ...
    const register = useCallback(async (email: string, password: string, firstName: string, lastName: string, dob: string, roleName: string) => {
        setLoading(true);
        setError(null);
        try {
