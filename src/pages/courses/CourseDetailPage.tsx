...
import { FaPlay, FaStar, FaCheck, FaChevronDown, FaPlayCircle } from 'react-icons/fa';
import { MdDescription, MdSchedule, MdWorkspacePremium, MdAllInclusive, MdDevices } from 'react-icons/md';

// Mock data - replace with API call
const courseData = {
  id: '1',
  title: 'Lập trình Web Fullstack từ con số 0',
  description: 'Khóa học này được thiết kế để đưa bạn từ một người mới bắt đầu hoàn toàn trở thành một nhà phát triển Fullstack thực thụ. Bạn sẽ học cách xây dựng các ứng dụng web hiện đại từ giao diện người dùng đến hệ thống phía máy chủ.',
  thumbnail: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBTnu7tEadFCucDTlaAYiK551HnOiunBrzBEvJvjSAiH44h1-8cIlJ0zQWt1js5roKSbrku9jF1Yu6uDmgceEeVAZLHSSdB2jY1UP1QghqTBHex_Jb0mNvP-ZMM4yivUdNWXLGrvRZu9aFV8zDdwNPUyu1deOWn4fPafTJIIjwePvbzS3GAJrwG8JppgRC-tTGiytn-NeR-z5aUuIb8v-PWmeBsK3-LlvB8-XDv__U9sVQKeLNblrSArbJLXjCVFasNsjbc0gcdOsFB',
  rating: 4.8,
  reviews: 1250,
  students: 15402,
  price: 1200000,
...
const relatedCourses = [
  ...
  },
  {
    ...
    price: 1500000,
    rating: 4.7,
    thumbnail: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBUM01xgb-NDQxsaEe0JFrpbOH89-eMBvb1to2vtQ_zbRzk5COFNi3aKv9BNQJ7cAy2gOBGKrO0tp-2g3oxYo3WyVcSxbAnu2RHEQPIUgmBfMziv4qD43rNuZNu_nirhugILjQCcbDAy1E5HFTj0xvhmL3_bJkt_BOYKn8jy01693yXOxQICvLsJHJ5TrLjPx96lHCKR7miZrI195cCw9Hxnk2Rqw0FNZ8uvC7azGiaBhntc9UrZVwAO24noD_jr7QA47YtF6XNRhCj'
  },
  {
    id: '4',
    ...
    price: 1100000,
    rating: 4.6,
    thumbnail: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBXTI27iXOPvdI1ImreB2it5S8pGjlI6D3sefLhZTLMZUu2s5I4GcNQNco54jsFNx2DMTA9u806pjXZqlSwPjkhhiwoL4dNBqK_S_tWG_ptJAp2ZquDLXHaXFoQvTxNCACnEVz803gxvJ2vbxAeV4eSreFv-GRvriItejT2V5ysRvRxsl-NJ9k7XDbQMU2aA8076tCM42hc7rR5T8Ma8q0LVPY9TaGtTkmP-BiS8OBynsN8kH9A226f79oCeeulXV2D0VzGcmgfWdAt'
  }
];

const CourseDetailPage = () => {
  const [activeTab, setActiveTab] = useState<'intro' | 'content' | 'reviews'>('intro');
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-[1280px] mx-auto px-6 py-4">
          <nav className="flex text-sm text-gray-600">
            <Link to="/" className="hover:text-[#0077BE]">Trang chủ</Link>
            <span className="mx-2">/</span>
            <Link to="/courses" className="hover:text-[#0077BE]">{courseData.category}</Link>
            <span className="mx-2">/</span>
      ...
      <div className="max-w-[1280px] mx-auto px-6 py-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="relative aspect-video w-full rounded-2xl overflow-hidden bg-black shadow-xl">
              ...
              <div className="absolute inset-0 flex items-center justify-center group cursor-pointer hover:bg-black/20 transition-colors">
                <div className="bg-[#0077BE] text-white w-20 h-20 rounded-full flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform">
                ...
                <button
                  className={`px-6 py-4 text-sm font-bold border-b-2 transition-colors ${
                    activeTab === 'intro'
                      ...
                      : 'text-gray-600 border-transparent hover:text-[#0077BE]'
                  }`}
                ...
                {activeTab === 'intro' && (
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="flex items-center gap-4 flex-wrap">
                      ...
                      <span className="text-gray-600 text-sm">({courseData.reviews.toLocaleString('vi-VN')} đánh giá)</span>
                      <span className="text-gray-400">•</span>
                      <span className="text-gray-600 text-sm">{courseData.students.toLocaleString('vi-VN')} học viên</span>
                    </div>
                        ...
                        >
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <span className="font-bold text-[#0077BE]">Phần {index + 1}:</span>
                              ...
                              {section.lessons.map((lesson, lessonIndex) => (
                                ...
                                >
                                  <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-gray-700">{lessonIndex + 1}. {lesson.title}</span>
                                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
              ...
              <div className="p-6 flex flex-col gap-6">
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-black text-[#0077BE]">
                ...
                <div className="flex flex-col gap-3">
                  <button className="w-full h-12 bg-[#0077BE] text-white font-medium rounded-lg hover:bg-[#0066a3] transition-all shadow-md">
                    Đăng ký ngay
                  </button>
                  <button className="w-full h-12 border-2 border-[#0077BE] text-[#0077BE] font-medium rounded-lg hover:bg-[#0077BE]/5 transition-all">
                    Thêm vào giỏ hàng
                  </button>
                </div>
                ...
                <div className="pt-4 border-t border-gray-200 text-center">
                  <button className="text-[#0077BE] text-sm font-bold hover:underline">
                    Nhập mã giảm giá
                  </button>
                </div>
              </div>
        ...
        <section className="mt-16 py-12 border-t border-gray-200">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="/courses" className="text-[#0077BE] text-sm font-bold hover:underline">
              Xem thêm
            </Link>
          </div>
            ...
            {relatedCourses.map((course) => (
              ...
              >
                ...
                <div className="p-4 flex flex-col gap-2">
                  <h4 className="font-bold group-hover:text-[#0077BE] transition-colors">
                    {course.title}
                  </h4>
                  <p className="text-xs text-gray-600">{course.instructor}</p>
                  <div className="flex items-center justify-between mt-2">
                    <span className="text-[#0077BE] font-bold">{formatPrice(course.price)}</span>
